...
import com.gtsupport.crawler4j.crawler.CrawlConfig;
import com.gtsupport.crawler4j.crawler.Page;
import com.gtsupport.crawler4j.crawler.exceptions.PageBiggerThanMaxSizeException;
import com.gtsupport.crawler4j.fetcher.PageFetchResult;
import com.gtsupport.crawler4j.fetcher.PageFetcher;
import com.gtsupport.crawler4j.url.WebURL;
import com.gtsupport.crawler4j.util.Util;
...
public class RobotstxtServer {
    ...
    protected RobotstxtProcessor processor;
    ...
    public RobotstxtServer(RobotstxtConfig config, RobotstxtProcessor processor, PageFetcher pageFetcher) {
        this(config, processor, pageFetcher, 16384);
    }

    public RobotstxtServer(RobotstxtConfig config, PageFetcher pageFetcher, int maxBytes) {
        this(config, new RobotstxtProcessor(), pageFetcher, maxBytes);
    }

    public RobotstxtServer(RobotstxtConfig config, RobotstxtProcessor processor, PageFetcher pageFetcher, int maxBytes) {
        this.config = config;
        ...
        try {
            ...
            if (fetchResult.getStatusCode() == HttpStatus.SC_OK) {
                ...
                if (Util.hasPlainTextContent(page.getContentType())) {
                    ...
                    content = processor.preProcess(robotsTxtUrl, content);
                ...
                if (content != null) {
                    processor.postProcess(robotsTxtUrl, content);
                }
            } else {
